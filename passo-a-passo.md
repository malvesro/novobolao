...
7. **[Em Progresso] Auditoria de Acessibilidade:** Inventário inicial realizado em 20/02/2026 com foco em WCAG 2.1 AA. Principais achados: bandeiras/ícones com `alt` vazio (necessário texto alternativo), IDs duplicados nos filtros de jogos, falta de `role`/gestão de foco nos balões de palpites, ausência de landmarks semânticos e feedbacks dependentes apenas de cor. Referência log: `.ia/logs/session-20260220-auditoria-acessibilidade.md`. Próximas etapas: aplicar correções e validar com axe/Lighthouse visando score > 90.
