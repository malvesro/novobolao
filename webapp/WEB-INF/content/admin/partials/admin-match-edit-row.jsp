        ...
        <form hx-post="${pageContext.request.contextPath}/admin/salvarEdicaoEstrutural.action"
            ...
            <div class="admin-edit-grid">
                <div class="admin-edit-field">
                    ...
                    <select name="data" class="form-control form-control--small">
                ...
                <div class="admin-edit-field">
                    ...
                    <select name="hora" class="form-control form-control--small">
                ...
                <div class="admin-edit-field">
                    ...
                    <input type="text" name="local" value="${jogo.local}" maxlength="120" class="form-control form-control--small" />
                </div>
                <div class="admin-edit-field">
                    <label><fmt:message key="match.phase" /></label>
                    <select name="fase" class="form-control form-control--small">
                ...
                <div class="admin-edit-field admin-edit-field--teams">
                    <label><fmt:message key="match.teams" /></label>
                    <div class="team-select-wrapper">
                        <select name="equipe1Id" class="form-control form-control--small">
                        ...
                        <select name="equipe2Id" class="form-control form-control--small">
                            <c:forEach var="eq" items="${equipes}">
                ...
                <div class="admin-edit-actions">
                    ...
                    <div class="htmx-indicator progress-spinner"></div>
                </div>
            </div>
        </form>
    </td>
