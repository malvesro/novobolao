<div style="height: 90px;"></div>
    <c:if test="${not empty param.status and param.status eq 'invalido'}"> 
    	...
    	<script type="text/javascript">
    		var errorTimeout = 0;
    		Effect.Pulsate($("login_error"));
    		var fadeFunc = function() {
    			Effect.Fade($("login_error"));
...
<form action="j_security_check" method="post">
	<div class="inner">
		<table class="form" cellspacing="0" cellpadding="2" style="width:100%; margin-top: 10px; margin-bottom: 10px;">
			<tr>
				<td class="label"><label for="login_username"><fmt:message key="login.username" /></label></td>
				<td class="widget"><input id="login_username" type="text" name="j_username" class="text" /></td>
			</tr>
			<tr>
				<td class="label"><label for="login_pwd"><fmt:message key="login.pwd" /></td>
			...
			<tr>
				<td style="text-align: center;" colspan="2">
                    ...
                    <a href="${cadastroFormURL}"><fmt:message key="login.signin" /></a>
                </td>
			</tr>
		</table>
	</div>
